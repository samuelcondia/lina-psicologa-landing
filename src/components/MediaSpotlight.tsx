...
function VideoBlock({
  ...
  return (
    <div className="min-w-0">
      ...
      <p className="mt-2 text-sm text-marino/70">{descripcion}</p>
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid gap-10 md:grid-cols-2">
          <VideoBlock
            ...
            titulo="Sanar e integrar"
            descripcion="Meditaciones gratuitas para acompañarte entre sesión y sesión, desde un enfoque holístico."
            videoId={site.videoMeditacionId}
          />
          <VideoBlock
            eyebrow="Podcast"
            titulo="Echando el cuento"
            descripcion="Conversaciones con invitados expertos en bienestar, salud mental y crecimiento personal."
            videoId={site.videoPodcastId}
          />
        </div>
